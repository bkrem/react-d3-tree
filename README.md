...
| `orientation`                 | `string` (enum)        | `horizontal` `vertical` `invertical`                                                               |           | `horizontal`                                                  | `horizontal` - Tree expands left-to-right. <br /><br /> `vertical` - Tree expands top-to-bottom. <br /><br /> `invertical` - Tree expands bottom-to-top.                                                                                                                                                                                                                                                                                                                              |
