...
var Node = /** @class */ (function (_super) {
    ...
    function Node() {
        ...
        _this.handleReplaceChildren = function (childrenData) {
            _this.props.handleAddChildrenToNode(_this.props.data.__rd3t.id, childrenData, true);
        };
        _this.handleUpdateNodeAttributes = function (attributes) {
            _this.props.handleUpdateNodeAttributes(_this.props.data.__rd3t.id, attributes);
        };
        _this.handleRemoveNode = function () {
            _this.props.handleRemoveNode(_this.props.data.__rd3t.id, _this.props.parent.data.__rd3t.id);
        };
        return _this;
    }
