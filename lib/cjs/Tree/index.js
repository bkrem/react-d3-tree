...
var Tree = /** @class */ (function (_super) {
    ...
    function Tree() {
        ...
        _this.handleRemoveNode = function (nodeId, parentNodeId) {
            var data = (0, clone_1.default)(_this.state.data);
        ...
        _this.handleUpdateNodeAttributes = function (nodeId, node) {
            var data = (0, clone_1.default)(_this.state.data);
            var matches = _this.findNodesById(nodeId, data, []);
            if (matches.length > 0) {
                var targetNodeDatum = matches[0];
        ...
        _this.handleAddChildrenToNode = function (nodeId, childrenData, replace) {
            var _a;
            var data = (0, clone_1.default)(_this.state.data);
            var matches = _this.findNodesById(nodeId, data, []);
            if (matches.length > 0) {
