...
export default class Node extends React.Component {
  constructor() {
    ...
    this.shouldNodeTransform = (ownProps, nextProps, ownState, nextState) =>
    ...
    this.renderNodeElement = () => {
      ...
      const renderNode =
        typeof renderCustomNodeElement === 'function'
